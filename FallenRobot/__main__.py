...
*๏ ᴀᴋᴜ ᴀᴅᴀʟᴀʜ* {} !
➻ sᴇᴍᴜᴀ ғɪᴛᴜʀᴇ ɪɴɪ ɢʀᴀᴛɪs ʏᴀ!!

──────────────────
*๏ ᴘɪʟɪʜ ᴛᴏᴍʙᴏʟ ʜᴇʟᴘ ᴜɴᴛᴜᴋ ᴍᴇʟɪʜᴀᴛ sᴇᴍᴜᴀ ғɪᴛᴜʀ ʏᴀɴɢ ᴛᴇʀsᴇᴅɪᴀ.*
"""

buttons = [
    [
        InlineKeyboardButton(
            text="ᴛᴀᴍʙᴀʜɪɴ ᴋᴇ ɢʀᴏᴜᴘ",
            url=f"https://t.me/{BOT_USERNAME}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="ʜᴇʟᴩ", callback_data="help_back"),
        InlineKeyboardButton(text="🤖 ᴜsᴇʀʙᴏᴛ 🤖 ", url=f"t.me/zull_probot"),
    ],
]
...
➲ /start : ᴜɴᴛᴜᴋ ᴍᴇᴍᴜʟᴀɪ ʙᴏᴛ
➲ /help  : ᴍᴇʟɪʜᴀᴛ ᴘᴇʀɪɴᴛᴀʜ ʏᴀɴɢ ᴛᴇʀsᴇᴅɪᴀ.
"""
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/botdev72/)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/cacacr4ck/FallenRobot/blob/master/LICENSE).
